...
export default function (streamId) {
    const quality = randomItem("SD", "HD", "FHD", "QHD", "UHD")
    const changeStreamQualityResponse = http.post(`${STREAMING_SERVICE_URL}/actions/resume?stream_id=${streamId}quality=${quality}`)
    check(changeStreamQualityResponse, {
